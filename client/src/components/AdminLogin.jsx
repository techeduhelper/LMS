          ...
          <div className="bg-gray-100 rounded-lg py-12 px-4 lg:px-28 flex flex-col items-center justify-center w-full">
            ...
            <form className="mt-6">
              ...
              <div className="flex items-center justify-center mt-8">
                <button className="text-white py-2 px-4 uppercase rounded-full bg-green-500 hover:bg-green-600 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5 w-full ">
                  Sign in
                </button>
              </div>
            </form>
