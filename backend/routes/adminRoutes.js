...
import { addAdmin, getAllSubject, getAllStudents, adminLogin, getAllFaculty, getAllFaculties, addFaculty, addStudent, addSubject, getAllSubjects } from '../controller/adminController.js';
...
router.post('/getAllStudent', passport.authenticate('jwt', { session: false }), getAllStudents);
...
router.get('/getFaculties', passport.authenticate('jwt', { session: false }), getAllFaculties);
